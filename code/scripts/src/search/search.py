...
# print("Search test: ", os.getenv("PODCAST_PATH"))
# conf = OmegaConf.load("../../config.yaml")
conf = OmegaConf.load("./config.yaml")
PODCAST_PATH =  conf.PODCAST_PATH
YAMNET_PATH = conf.YAMNET_PATH
class Searcher:
    ...
    def __init__(self, config_path="./config.yaml"):
        ...
        self.yamnet_model.load_weights(
            os.path.join(PODCAST_PATH, "data/yamnet.h5")
        )
    ...
    def elasticsearch_test(self, num_segments=10):
        ...
        with open(
            os.path.join(PODCAST_PATH, "data/test_es.pkl"), "rb"
        ) as f:
