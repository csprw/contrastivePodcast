...
echo "STARTING 12"
python evaluate_summary.py  --model_weights_path logs/15m-mlp_2022-07-05_10-52-12/output/full_model_weights.pt


echo "STARTING 14"
python evaluate_summary.py  --model_weights_path logs/15m-sph_2022-07-19_18-10-51/output/full_model_weights.pt


echo "STARTING 21"
python evaluate_summary.py  --model_weights_path logs/30m-gru_v2_2022-07-06_07-25-51/output/full_model_weights.pt

echo "STARTING 22"
python evaluate_summary.py  --model_weights_path logs/30m-mlp_2022-07-05_10-54-42/output/full_model_weights.pt

echo "STARTING 23"
python evaluate_summary.py --model_weights_path logs/25m-sph_2022-07-16_19-44-36/output/full_model_weights.pt
