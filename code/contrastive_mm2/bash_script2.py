...
job = "gru_test2.py --num_epochs 1 --audio_proj_head gru --pad_pack --loss_type simcse_loss --normalize"
cmd = process_args(job)
print("4---------------------------- Starting: ", cmd)
time.sleep(1)
subprocess.run(cmd, shell=False)

job = "gru_test2.py --num_epochs 1 --audio_proj_head rnn --pad_pack --loss_type simcse_loss --normalize"
cmd = process_args(job)
print("4---------------------------- Starting: ", cmd)
time.sleep(1)
subprocess.run(cmd, shell=False)

job = "gru_test2.py --num_epochs 1 --audio_proj_head rnn --pad_pack --loss_type clip_loss --normalize"
cmd = process_args(job)
print("4---------------------------- Starting: ", cmd)
time.sleep(1)
subprocess.run(cmd, shell=False)
