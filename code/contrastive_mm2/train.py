            ...
            if self.load_full:
                ...
                for enum, i in enumerate(index):
                    ...
                    if h5py_idx != last_idx:
                        ...
                        print("[del4 --TEST--] loaded new h5py file: ", h5py_idx, h5py_file)
                ...
                # sample = (text_embeds, audio_embeds, targets)

                # text_embeds, audio_embeds, lengths, targs, full_text
